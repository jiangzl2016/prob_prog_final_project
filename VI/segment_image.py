...
# Prediction
y, point = predict_cluster(approx=advi_mf.approx, nsample=1000, X=X, model=model, xobs=xobs, K=K)
...
pdi, pdi_log, wapdi = PDI(post_samples, model) # average over 100 samples
